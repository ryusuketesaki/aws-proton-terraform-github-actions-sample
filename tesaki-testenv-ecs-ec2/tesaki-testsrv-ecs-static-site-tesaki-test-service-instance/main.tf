...
To manage this resource, see AWS Proton Resource: arn:aws:proton:ap-northeast-1:808225968452:service/tesaki-testsrv-ecs-static-site/service-instance/tesaki-test-service-instance
